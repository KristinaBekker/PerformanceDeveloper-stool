 ...
 * @generated
 */
public class UserPerformancePackageImpl extends EPackageImpl implements UserPerformancePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see UserPerformance.UserPerformancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UserPerformancePackageImpl() {
		super(eNS_URI, UserPerformanceFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link UserPerformancePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UserPerformancePackage init() {
		if (isInited) return (UserPerformancePackage)EPackage.Registry.INSTANCE.getEPackage(UserPerformancePackage.eNS_URI);

		// Obtain or create and register package
		UserPerformancePackageImpl theUserPerformancePackage = (UserPerformancePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UserPerformancePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UserPerformancePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theUserPerformancePackage.createPackageContents();

		// Initialize created meta-data
		theUserPerformancePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theUserPerformancePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UserPerformancePackage.eNS_URI, theUserPerformancePackage);
		return theUserPerformancePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getUser_Descriptoin() {
	 ...
	 * @generated
	 */
	public EAttribute getTask_DateStart() {
	 ...
	 * @generated
	 */
	public EAttribute getTask_DateEnd() {
	 ...
	 * @generated
	 */
	public EAttribute getTask_CurrentDate() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_TimePassive() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_TimeActive() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_TypingSpeed() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_NumberOfCharacters() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_CountSavedEditing() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_NumberOfSwitches() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_ErrorsCount() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_TimeToCorrectionErrors() {
	 ...
	 * @generated
	 */
	public EAttribute getParameters_TypoCount() {
	 ...
	 * @generated
	 */
	public EReference getInterval_Parameter() {
	 ...
	 * @generated
	 */
	public EReference getPerformance_Users() {
	 ...
	 * @generated
	 */
	public UserPerformanceFactory getUserPerformanceFactory() {
		return (UserPerformanceFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(userEClass, USER__PARAMETERS);
		createEReference(userEClass, USER__INTERVALS);
		createEAttribute(userEClass, USER__DESCRIPTOIN);

		taskEClass = createEClass(TASK);
		createEAttribute(taskEClass, TASK__NAME);
		createEAttribute(taskEClass, TASK__STATUS);
		createEAttribute(taskEClass, TASK__DATE_START);
		createEAttribute(taskEClass, TASK__DATE_END);
		createEAttribute(taskEClass, TASK__CURRENT_DATE);
		createEAttribute(taskEClass, TASK__DESCRIPTION);
		createEReference(taskEClass, TASK__SUBTASKS);
		createEReference(taskEClass, TASK__PARAMETERS);

		parametersEClass = createEClass(PARAMETERS);
		createEAttribute(parametersEClass, PARAMETERS__TIME_PASSIVE);
		createEAttribute(parametersEClass, PARAMETERS__TIME_ACTIVE);
		createEAttribute(parametersEClass, PARAMETERS__TYPING_SPEED);
		createEAttribute(parametersEClass, PARAMETERS__NUMBER_OF_CHARACTERS);
		createEAttribute(parametersEClass, PARAMETERS__COUNT_SAVED_EDITING);
		createEAttribute(parametersEClass, PARAMETERS__NUMBER_OF_SWITCHES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUser_Name(), ecorePackage.getEString(), "name", "Common", 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUser_Parameters(), this.getParameters(), null, "parameters", null, 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUser_Intervals(), this.getInterval(), null, "intervals", null, 0, -1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUser_Descriptoin(), ecorePackage.getEString(), "descriptoin", "Common time", 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTask_Parameters(), this.getParameters(), null, "parameters", null, 0, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(parametersEClass, Parameters.class, "Parameters", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getParameters_TimePassive(), ecorePackage.getEDouble(), "timePassive", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameters_TimeActive(), ecorePackage.getEDouble(), "timeActive", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameters_TypingSpeed(), ecorePackage.getEDouble(), "typingSpeed", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameters_NumberOfCharacters(), ecorePackage.getEInt(), "numberOfCharacters", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameters_CountSavedEditing(), ecorePackage.getEInt(), "countSavedEditing", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameters_NumberOfSwitches(), ecorePackage.getEInt(), "numberOfSwitches", "0", 0, 1, Parameters.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
